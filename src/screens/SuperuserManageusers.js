...
import { AiOutlineDownload, AiOutlineClose, AiOutlineEye } from 'react-icons/ai'
...
const SuperuserManageusers = () => {
    ...
    const filteredInterns = data.userr.filter((intern) => {
                          ...
                          {data.mentorr.map((e, index) => {
                            return <div key={e._id} className='idleIntern-box'> 
                              ...
                              <div id='idle-employee-right-part'>
                                ...
                                <div id='idle-employee-assignTask'><GrPowerReset style={{ marginRight: "1vw" }} data-toggle="tooltip" data-placement="top" title="Reset Password" onClick={() => { setShow(true); setId(e._id); setType('mentor') }} /> <FiSettings className='AiOutlinePlus' style={{ fontSize: '17px' }} /> </div>
                              </div>
                          ...
                          {filteredInterns.map((e, index) => {
                            return <div key={e._id} className='idleIntern-box'>
                              ...
                              <div id='idle-employee-right-part'>
                                ...
                                <div id='idle-employee-assignTask'><GrPowerReset style={{ marginRight: "1vw" }} data-toggle="tooltip" data-placement="top" title="Reset Password" onClick={() => { setShow(true); setId(e._id); setType('user') }} />
                                  ...
                                  <AiOutlineDownload style={{ fontSize: "20px" }} data-toggle="tooltip" data-placement="top" title="Download Report" /></div>
                              </div>
